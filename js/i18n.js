...
(function (global) {
  const translations = {
    en: {
      ...
      "scan.statusModerationCapturing": "Preparing frames for OpenAI Moderation API…",
      "scan.statusModerationChecking": "Confirming with OpenAI Moderation API ({current}/{count})…",
      ...
      "timecodesDialog.snapshotGridHint": "Click a thumbnail to unblur it. Uncheck a scene to exclude it from blur during playback and from subtitle export.",
      "timecodesDialog.moderationFilterLabel": "Show only results confirmed by OpenAI moderation",
      "timecodesDialog.snapshotGridCountHint": {
        one: "Showing {shown} of {total} result.",
        few: "Showing {shown} of {total} results.",
        many: "Showing {shown} of {total} results.",
        other: "Showing {shown} of {total} results.",
      },
      "timecodesDialog.snapshotCheckboxLabel": "Include this scene",
      "timecodesDialog.snapshotUnavailable": "No preview",
      ...
      "settings.blurRadius": "Blur radius",
      "settings.blurRadiusHint": "How strong the blur effect is during playback — a larger value blurs more.",
    ...
    uk: {
      ...
      "scan.confirmingNoSkippedSuffix": "…",
      "scan.statusModerationCapturing": "Підготовка кадрів для OpenAI Moderation API…",
      "scan.statusModerationChecking": "Підтвердження через OpenAI Moderation API ({current}/{count})…",
      ...
      "timecodesDialog.snapshotGridHint": "Натисніть на мініатюру, щоб прибрати розмиття. Зніміть позначку зі сцени, щоб виключити її з розмиття під час відтворення та з експорту субтитрів.",
      "timecodesDialog.moderationFilterLabel": "Показувати лише результати, підтверджені OpenAI moderation",
      "timecodesDialog.snapshotGridCountHint": {
        one: "Показано {shown} з {total} результату.",
        few: "Показано {shown} з {total} результатів.",
        many: "Показано {shown} з {total} результатів.",
        other: "Показано {shown} з {total} результатів.",
      },
      "timecodesDialog.snapshotCheckboxLabel": "Включити цю сцену",
      "timecodesDialog.snapshotUnavailable": "Немає перегляду",
      ...
      "settings.blurRadius": "Радіус розмиття",
      "settings.blurRadiusHint": "Наскільки сильний ефект розмиття під час відтворення — більше значення означає сильніше розмиття.",
